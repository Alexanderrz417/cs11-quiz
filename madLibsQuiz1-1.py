...
print("MadLibs is a fill-in-the-blanks story game.")
print("The player must choose words based on the given prompts,")
print("and the computer will return a short story that includes the words the user chose.")
